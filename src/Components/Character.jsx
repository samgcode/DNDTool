  ...
  return (
    <div>
      {(showHeadings) ?
        ...
        <form className={character.isTurn ? 'row border-2 rounded-lg border-green-400' : 'row'} onSubmit={handleChange}>
          <input className='field w-32' name='name' onChange={handleChange} value={formData.name} type='text' onBlur={handleChange}></input>
          <div className='flex content-center w-32 justify-center'>
            <input className='field w-10' name='currentHp' onChange={handleChange} value={formData.currentHp} type='text' onBlur={handleChange}></input>
            <h1 className='text-lg my-auto pr-2 text-center pl-1'>/</h1>
            <input className='field w-10' name='maxHp' onChange={handleChange} value={formData.maxHp} type='text' onBlur={handleChange}></input>
            <h1 className='text-lg my-auto pr-2 text-center'>hp</h1>
          </div>
          <div className='flex w-32 justify-center'>
            <h1 className='text-lg my-auto pr-2 text-center -mr-2'>+</h1>
            <input className='field w-10' name='initiativeModifier' onChange={handleChange} value={formData.initiativeModifier} type='number' onBlur={handleChange}></input>
          </div>
          <div className='flex w-32 justify-center'>
